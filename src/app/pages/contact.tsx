  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const n8nResponse = await fetch(
        "https://appn8n-n8n.nhpowe.easypanel.host/webhook/03b47efa-823b-4f87-8605-4e145c09bd44",
        {
          method: "POST",
          headers: {
        ...
        <div className="relative z-10 w-full px-4 md:px-8 lg:px-16">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-slate-300 mb-12 leading-relaxed max-w-3xl mx-auto">
              Estamos aquí para transformar tu visión en realidad. Contacta con
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 md:p-10 border border-slate-200">
                  <div className="relative z-10">
                    ...
                    <p className="text-slate-600 mb-6 text-base">
                      Completa el formulario y recibe una cotización
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-300 text-sm">
                          Verano #11, Betania, <br /> 76807 San Juan del Río,
                          Qro.
                        </p>
                      </div>
                    </div>
