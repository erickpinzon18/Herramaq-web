          ...
          {cta && (
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
              <Link href={cta.href} className="w-full sm:w-auto">
                <RBButton
                  variant="primary"
                  className="px-6 md:px-8 py-3 md:py-4 text-base md:text-lg shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 w-full sm:w-auto"
                >
                  {cta.label} →
                </RBButton>
              </Link>
              <Link href="/contact" className="w-full sm:w-auto">
                <RBButton
                  variant="outline"
                  className="px-6 md:px-8 py-3 md:py-4 text-base md:text-lg hover:scale-105 transition-all duration-300 w-full sm:w-auto"
                >
                  Contactar Ventas
                </RBButton>
              </Link>
        ...
        <div className="animate-fade-in-right">
          <div className="relative w-full h-[500px] lg:h-[600px] rounded-3xl bg-gradient-to-br from-slate-700 via-slate-800 to-slate-900 overflow-hidden shadow-2xl">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div
                className="absolute w-40 h-40 bg-white/10 rounded-3xl animate-spin-slow backdrop-blur-sm"
                style={{ animationDuration: "25s" }}
              ></div>
              <div
                className="absolute w-32 h-32 bg-slate-400/20 rounded-full animate-bounce backdrop-blur-sm"
              ...
              <div
                className="absolute w-24 h-24 bg-slate-300/20 rounded-lg animate-spin-slow"
            ...
            <div
              className="absolute bottom-20 right-20 w-4 h-4 bg-yellow-400/60 rounded-full animate-ping"
              style={{ animationDelay: "0.5s" }}
            ></div>
            <div
              className="absolute top-1/3 right-10 w-2 h-2 bg-white/60 rounded-full animate-ping"
