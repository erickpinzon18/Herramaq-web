      ...
      setMessages([
        {
          role: "assistant",
          content:
            "¡Hola! 👋 Soy el asistente virtual de Herramaq. ¿En qué puedo ayudarte hoy? Puedo brindarte información sobre nuestros productos, servicios, capacidades técnicas o coordinar una cotización.",
          timestamp: new Date(),
        },
      ]);
    }
        ...
        try {
          ...
          if (textParam) {
            ...
            if (decodedText.toLowerCase().includes("cotizar")) {
              ...
              decodedText.toLowerCase().includes("información") ||
              decodedText.toLowerCase().includes("info")
            ) {
              buttonText = "Solicitar información";
            } else if (
              decodedText.toLowerCase().includes("visita") ||
              decodedText.toLowerCase().includes("agendar")
            ) {
              buttonText = "Agendar visita";
            } else if (
              decodedText.toLowerCase().includes("consulta") ||
              decodedText.toLowerCase().includes("técnica")
            ) {
