...
export const brandLogos: Record<string, BrandLogo> = {
    ...
    'BISON': {
        name: 'BISON',
        logoUrl: 'https://tradetoolscia.com.pe/wp-content/uploads/2025/05/LOGO-BISON-1024x339.png',
        website: ''
        // 112 productos
    },
    'VOLKEL': {
    ...
    'LENOX': {
        name: 'LENOX',
        logoUrl: 'https://ferreflex.mx/cdn/shop/collections/LENOX.jpg?v=1721083204',
        website: ''
        // 60 productos
    },
    'NICHOLSON': {
    ...
    'NOGA': {
        name: 'NOGA',
        logoUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQlJnk6y_0TqlATlEhIYLcyVnzWZPMVCZEOA&s',
        website: ''
        // 21 productos
    },
    'BRICK': {
